...
namespace RCM.Metrics
{
    ...
    [MetricInfoAttribute(Name = "Number of References", Type = typeof(ReferencesMetric))]
    // TheNASAArm
    class ReferencesMetric:IMetric
    {
        public static string[] DefaultKeywords = {  "e.g.", "i.e.","for example", "figure", "table", "note" };
