...
namespace RCM.Metrics
{
    ...
    [MetricInfoAttribute(Name = "Imperatives", Type = typeof(ImperativesMetric))]
    //TheNasaARM
    class ImperativesMetric:IMetric
    {
        public static string[] DefaultKeywords ={"shall", "must", "is required to", "are applicable", "are to", "responsible for", "will", "should"  };
        public override string ToString()
        {
            return "Number of imperatives";
        }
