...
namespace RCM.Metrics
{
    ...
    [MetricInfoAttribute(Name = "Continuances", Type = typeof(ContinuancesMetric))]
    class ContinuancesMetric:IMetric
    {

        public static string[] DefaultKeywords = {"below", "as follows", "following", "listed", "in particular", "support", "and", ":"};
            public override string ToString()
        {
            return "Number of continuances";
        }
